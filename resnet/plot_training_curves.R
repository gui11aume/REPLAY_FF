...
b = read.table("learning_curves_ctrl.txt")
...
pdf("training.pdf", useDingbats=FALSE, height=3, width=5)
par(mar=c(3,3,0.5,1))
plot(1:100, am, lwd=3, type="n", ylim=c(-3.3,-2.8),
...
a = read.table("learning_curves_full_6xPCR.txt")
b = read.table("learning_curves_ctrl_6xPCR.txt")

am = tapply(X=a$V3, INDEX=a$V1, median)
aup = tapply(X=a$V3, INDEX=a$V1, quantile, .985)
adn = tapply(X=a$V3, INDEX=a$V1, quantile, .015)

bm = tapply(X=b$V3, INDEX=b$V1, median)
bup = tapply(X=b$V3, INDEX=b$V1, quantile, .985)
bdn = tapply(X=b$V3, INDEX=b$V1, quantile, .015)
...
pdf("training_6xPCR.pdf", useDingbats=FALSE, height=3, width=5)
par(mar=c(3,3,0.5,1))
plot(1:100, am, lwd=3, type="n", ylim=c(-5,-2.5),
   panel.first=grid(nx=NA, ny=NULL),
   bty="n", xaxt="n", yaxt="n", xlab="", ylab="")
polygon(c(1:100,100:1), c(bup, rev(bdn)), lty=0, col=tCOL[2])
polygon(c(1:100,100:1), c(aup, rev(adn)), lty=0, col=tCOL[1])
...
a = read.table("learning_curves_full_GC.txt")
b = read.table("learning_curves_ctrl_GC.txt")
...
pdf("training_GC.pdf", useDingbats=FALSE, height=3, width=5)
par(mar=c(3,3,0.5,1))
plot(1:100, am, lwd=3, type="n", ylim=c(-1.6,-.4),
   panel.first=grid(nx=NA, ny=NULL),
   bty="n", xaxt="n", yaxt="n", xlab="", ylab="")
polygon(c(1:100,100:1), c(bup, rev(bdn)), lty=0, col=tCOL[2])
polygon(c(1:100,100:1), c(aup, rev(adn)), lty=0, col=tCOL[1])
